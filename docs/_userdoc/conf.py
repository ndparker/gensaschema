# -*- coding: utf-8 -*-
#
# GenSASchema documentation build configuration file
#
...
.. |GenSASchema| replace:: :product:`GenSASchema`
...
epydoc = dict(
    gensaschema=os.path.join(os.path.abspath(os.path.pardir), 'apidoc'),
)
...
htmlhelp_basename = 'GenSASchemadoc'
