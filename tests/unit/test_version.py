...
================================
 Tests for gensaschema._version
================================
...
def test_repr():
    ...
    ver = _version.Version("1.2.3.4.foo", True, 5)
    assert repr(ver) == \
        "gensaschema._version.Version('1.2.3.4.foo', is_dev=True, revision=5)"

    ver = _version.Version("1.2.3.4.foo", False, 5)
    assert repr(ver) == \
        "gensaschema._version.Version('1.2.3.4.foo', is_dev=False, " \
        "revision=5)"

    ver = _version.Version("1.2.3.4.foo\xe9", True, 5)
    assert repr(ver) == \
        "gensaschema._version.Version('1.2.3.4.foo\\xe9', is_dev=True, " \
        "revision=5)"
